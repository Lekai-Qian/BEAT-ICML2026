...
class PianoTrainConfig:
    ...
    output_dir: str = "beat_camera/checkpoints/piano"
    log_dir: str = "beat_camera/logs/piano"
...
class MultitrackTrainConfig:
    ...
    output_dir: str = "beat_camera/checkpoints/multitrack"
    log_dir: str = "beat_camera/logs/multitrack"
