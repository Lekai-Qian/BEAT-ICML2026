...
Usage:
  ...
  CUDA_VISIBLE_DEVICES=0 python -m beat_camera.scripts.continue_piano \\
      --checkpoint beat_camera/checkpoints/piano/backbone_best.pt \\
...
def main():
    ...
    p.add_argument('--output_dir', type=str, default='beat_camera/samples/piano_continue',
