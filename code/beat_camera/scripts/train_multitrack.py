...
Usage:
  # single GPU
  CUDA_VISIBLE_DEVICES=0 python -m beat_camera.scripts.train_multitrack
  ...
  # resume
  python -m beat_camera.scripts.train_multitrack --resume checkpoints/multitrack/backbone_best.pt

Tensorboard:
  tensorboard --logdir beat_camera/logs/multitrack --port 6006
